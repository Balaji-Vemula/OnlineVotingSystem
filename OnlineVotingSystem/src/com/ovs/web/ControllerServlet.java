...
public class ControllerServlet extends HttpServlet {
    ...
    public void init() {
        ...
        adminDAO = new AdminDAO("jdbc:mysql://localhost:3306/mini", "root", "Balaji@123");
        voterDAO = new VoterDAO("jdbc:mysql://localhost:3306/mini", "root", "Balaji@123");
        candidateDAO= new CandidateDAO("jdbc:mysql://localhost:3306/mini", "root", "Balaji@123");
