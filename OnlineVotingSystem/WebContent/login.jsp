...
<body>
  ...
  <div class="container mt-2">
    ...
    <h2 class="text-center py-3 font-weight-bold">Administrator Login</h2>
    <div class="bg-white text-white p-3" style="border-radius:10px;">
      <form method="post" action="admin_login">
        ...
        <div class="input-group mb-2">
          ...
          <input name="pass" type="password" id="mypassword" class="form-control text-black border-right-0" placeholder="Password">
          <div class="input-group-append">
                    <span class="input-group-text bg-white">
                     <a onclick="myFunction()"><i class="fa fa-eye-slash" id="pwdIcon"></i></a>
                    </span>
                  </div>
        </div>
...
<%@ include file="Footer.jsp" %>
  ...
  function myFunction(){
      ...
      var y=document.getElementById("pwdIcon");
      if(x.type==="password")
      {
          x.type="text";
